...
class ChatIngestor:
    def __init__(self , temp_base : str = "data" , faiss_base:str="faiss_index" , 
        ...
        try:
            ...
            log.info("Chat Ingestor Initialized" ,
            ...
            log.error("Failed to initialize Chat Ingestor" , error = str(e))
    ...
    def built_retriever(self , uploaded_files : Iterable , * , 
                        ...
                        k : int = 5 , search_type : str = "mmr" , fetch_k:int = 20  , lambda_mult:float = 0.5):
        try:
