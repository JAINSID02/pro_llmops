...
class ConversationalRAG:
    ...
    def __init__(self , session_id:Optional[str] , retriever = None):
        try :
            ...
            log.info("ConverstionalRAG Initialized" , session_id = self.session_id)
    ...
    def load_retriever_from_faiss(
            self , index_path : str , k : int = 5 , index_name : str = "index" , search_type : str = "mmr" ,
            fetch_k : int = 20 , lambda_mult : float = 0.5 , search_kwargs : Optional[Dict[str  , Any]] = None
    ):
        """
        ...
        try :
            ...
            raise DocumentPortalException("Loading error in Conversational RAG" , sys   )
