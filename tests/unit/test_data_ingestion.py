...
from multi_doc_chat.src.document_ingestion.data_ingestion import (
    generate_session_id, ChatIngestor , FaissManager
)
...
def test_chat_ingestor_resolve_dir_use_session_dirs(tmp_dirs , stub_model_loader):
